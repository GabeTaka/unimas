...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Example Pages">
          ...
          <ul class="sidenav-second-level collapse" id="collapseExamplePages">
            <li>
              <a href="<?php echo site_url('/users/login/'); ?>">Login Page</a>
            </li>
            <li>
              <a href="<?php echo site_url('/users/register/'); ?>">Registration Page</a>
            </li>
            <li>
              <a href="<?php echo site_url('/users/forgot_password/'); ?>">Forgot Password Page</a>
            </li>
            <li>
      ...
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item">
          <a class="nav-link" data-toggle="modal" href="<?php echo site_url('/users/logout/'); ?>">
  ...
  <?php if($this->session->flashdata('forms_created')): ?>
    <?php echo '<p class="alert alert-success">'.$this->session->flashdata('forms_created').'</p>'; ?>
  <?php endif; ?>
