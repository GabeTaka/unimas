...
<form action="update" method="post" enctype="multipart/form-data" name="update_name" id="update_name" class="container-fluid" style="height: 100px;">
...
<!--             <li id="sustainability">Program Sustainability</li> -->
    ...
    <div class="row">
      <div class="col-md-5">
        <div class="form-group">
          ...
          <input type="text" class="form-control" name="project_name" id="project_name" value="<?php echo $info['project_name']; ?>">
        </div>
        <div class="form-group">
          <label>Course Code & Name:</label>
          <input type="text" class="form-control" name="course_code" id="course_code" value="<?php echo $info['course_code']; ?>">
        </div>
        <div class="form-group">
          <label>Organizer:</label>
          <input type="text" class="form-control" name="organizer" id="organizer" value="<?php echo $info['organizer']; ?>">
        </div>
        <div class="form-group">
          <label>Co-Organizer:</label>
          <input type="text" class="form-control" name="co_organizer" id="co_organizer" value="<?php echo $info['co_organizer']; ?>">
        </div>
        <div class="form-group">
        <label>Sustainability Framework</label>
        <div><textarea class="form-control" id="program_sustainability" name="program_sustainability" rows="3" style="margin-top: 0px; margin-bottom: 0px; " ><?php echo $info['program_sustainability']; ?></textarea></div>
        </div>
      </div>
    </div>
    <?php endforeach; ?>
  ...
  <div id="description-field" class="form-group" style="display: none;">
    ...
    <div class="row">
      ...
      <label>Project Synopsis</label>
        <div><textarea class="form-control" id="project_synopsis" name="project_synopsis" rows="3" style="margin-top: 0px; margin-bottom: 0px; "><?php echo $description['project_synopsis']; ?></textarea></div>
        <label>Justification of Project</label>
        <div><textarea class="form-control" id="justification_project" name="justification_project" rows="3" style="margin-top: 0px; margin-bottom: 0px; "><?php echo $description['justification_project']; ?></textarea></div>
        <label>Project Objectives</label>
        <div><textarea class="form-control" id="project_objectives" name="project_objectives" rows="3" style="margin-top: 0px; margin-bottom: 0px; "><?php echo $description['project_objectives']; ?></textarea></div>
        <label>Impact to the Community</label>
        <div><textarea class="form-control" id="impact_community" name="impact_community" rows="3" style="margin-top: 0px; margin-bottom: 0px; "><?php echo $description['impact_community']; ?></textarea></div>
      </div>
    </div>
    <?php endforeach; ?>
  </div>
  ...
  <div id="sdg-field" class="form-group" style="display: none;">
    ...
    <?php foreach($sdg_table as $sdg_table) : ?>
        ...
        <thead class="table-secondary">
                            ...
                            <thead>
                                <tr id="addr0">
                                   ...
                                   <td class="custom-tbl"><input type="text" class="form-control" id="sdg" name="sdg[]" value="<?php echo $sdg_table['sdg']; ?>"></td>
                                </tr>
                            </thead>
  ...
  <div id="milestone-field" class="form-group" style="display: none;">
    ...
    <?php foreach($milestone as $milestone) : ?>
    <div class="row">
      <div class="col-md-5">
        <div class="form-group">
          <label>Project Period:</label><br>
          <label>From: <input type="text" name="from_date" id="from_date" class="form-control" value="<?php echo $milestone['from_date']; ?>" placeholder="From Date" /></label>
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <label>To: <input type="text" name="to_date" id="to_date" value="<?php echo $milestone['to_date']; ?>" class="form-control" placeholder="To Date" /></label>
        </div>
        <div class="form-group">
          <label>Project Location:</label>
          <input type="text" class="form-control" name="project_location" id="project_location" value="<?php echo $milestone['project_location']; ?>">
        </div>
        <div class="form-group">
          <label>Project Milestone:</label>
          <input type="text" class="form-control" name="project_milestone" id="project_milestone" value="<?php echo $milestone['project_milestone']; ?>">
        </div>
      </div>
    </div>
    <?php endforeach; ?>
  ...
  <div id="target-field" class="form-group" style="display: none;">
    <h2>TARGET GROUPS</h2>
    <?php foreach($target_groups as $target_groups) : ?>
      <div class="row">
      <div class="col-md-5">
      <div class="form-group">
          <label>Number of Student Involve:</label>
          <input type="text" class="form-control" name="number_student" id="number_student" value="<?php echo $target_groups['number_student']; ?>">
        </div>
        <div class="form-group">
          <label>Community Target Group for the Project:</label>
          <input type="text" class="form-control" name="target" id="target" value="<?php echo $target_groups['target']; ?>">
        </div>
        <div class="form-group">
          <label>Justification for Selecting the Community:</label>
          <input type="text" class="form-control" name="justification" id="justification" value="<?php echo $target_groups['justification']; ?>">
        </div>
      <label>Activity Description</label>
        <div><textarea class="form-control" id="activity_description" name="activity_description" rows="4" style="margin-top: 0px; margin-bottom: 0px; "><?php echo $target_groups['activity_description']; ?></textarea></div>
    </div>
  </div>
  <?php endforeach; ?>
  </div>
  ...
  <div id="members-field" class="form-group" style="display: none;">
      ...
      <?php foreach($project_members as $project_members) : ?>
      <table class='table table-bordered table-hover' id="tab_logic">
                            <thead class="table-primary">
                                <tr class='info'>
                                    <th style='width:10%;'>NO</th>
                            ...
                            <thead>
                                <tr id="addr0">
                                    ...
                                    <td class="custom-tbl"><input class='form-control input-sm' style='width:100%;' type="text" id="members_name" name="members_name[]" value="<?php echo $project_members['members_name']; ?>"></td>
                                    <td class="custom-tbl"><input class='form-control input-sm' style='width:100%;' type="text" id="expertise" name="expertise[]" value="<?php echo $project_members['expertise']; ?>"></td>
                                    <td class="custom-tbl"><input class='form-control input-sm' style='width:100%;' type="text" id="position" name="position[]" value="<?php echo $project_members['position']; ?>"></td>
                                    <td class="custom-tbl"><input class='form-control input-sm' style='width:100%;' type="text" id="role" name="role[]" value="<?php echo $project_members['role']; ?>"></td>
                                    <td class="custom-tbl"><input class='form-control input-sm' style='width:100%;' type="text" id="email" name="email[]" value="<?php echo $project_members['email']; ?>"></td>
                                    <td class="custom-tbl"><input class='form-control input-sm' style='width:100%;' type="text" id="telephone" name="telephone[]" value="<?php echo $project_members['telephone']; ?>"></td>
...
<div class="table-responsive">
                        ...
                        <table class='table table-bordered table-hover' id="tab_logic">
                          <thead class="table-secondary">
                            ...
                            <?php foreach($project_budget as $project_budget) : ?>
                            <thead>
                                <tr id="addr0">
                                    ...
                                    <td class="custom-tbl"><input class='form-control input-sm' style='width:100%;' type="text" id="pr_qty0" oninput='multiply(0);' name="pr_qty[]" value="<?php echo $project_budget['pr_qty']; ?>"></td>
                                    <td class="custom-tbl"><input class='form-control input-sm' style='width:100%;' type="text" id="pr_desc0" name="pr_desc[]" value="<?php echo $project_budget['pr_desc']; ?>"></td>
                                    <td><input class='form-control input-sm' style='width:100%;' type="text" id="pr_cpu0" oninput='multiply(0);' name="pr_cpu[]" value="<?php echo $project_budget['pr_cpu']; ?>"></td>
                                    <td class="custom-tbl"><input class='estimated_cost form-control input-sm' id="pr_cpi0" style='width:100%;' type="text" name="pr_cpi[]" value="<?php echo $project_budget['pr_cpi']; ?>" readonly></td>
                                ...
                                <tr class='info'>
                                  <?php foreach($total as $total) : ?>
                                    ...
                                    <td style='padding:0px;'>
                                            ...
                                            <input style='width:100%;' type='text' class='form-control input-sm' id='grand_total' name='grand_total' value="<?php echo $total['grand_total']; ?>" readonly required>
  ...
  <?php foreach($facilities as $facilities) : ?>
        ...
        <thead class="table-secondary">
                            ...
                            <thead>
                                <tr id="addr0">
                                   ...
                                   <td class="custom-tbl"><input class='form-control input-sm' style='width:100%;' type="text" id="facility" name="facility[]" value="<?php echo $facilities['facility']; ?>"></td>
                                    <td class="custom-tbl"><input class='form-control input-sm' style='width:100%;' type="text" id="date" name="date[]" value="<?php echo $facilities['date']; ?>"></td>
                                    <td class="custom-tbl"><input class='form-control input-sm' style='width:100%;' type="text" id="unit" name="unit[]" value="<?php echo $facilities['unit']; ?>"></td>
    ...
    <button type="button" name="update" id="update" class="btn btn-success" style="display: none;">Update</button>
  ...
  else
  {
   ...
   $('#action_alert').dialog('open');
    ...
    $('#update').click(function(e){
     e.preventDefault();
     $.ajax({
       url:"<?php base_url(); ?>applicant/update",
       type:"POST",
       data:new FormData(document.getElementById("update_name")),  
       contentType: false,  
       cache: false,  
       processData:false,
       dataType:'json',  
