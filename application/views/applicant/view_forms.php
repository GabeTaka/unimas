            ...
            <?php if ('approved_forms') : ?>
              ...
              <?php foreach($info as $info) : ?>
                <tbody>
                  ...
                  <td>
                    <button style="width: 50%;" class="btn btn-info" onclick="location.href='<?php echo base_url(); ?>applicant/createpdf/<?php echo $info['info_id']; ?>'">View</button><button style="width: 50%;" type="button" class="btn btn-danger">Delete</button>
                  </tbody>
                <?php endforeach; ?>
              <?php endif; ?>
            </table>
